...
import com.github.vbsw.urlsaver.api.IProperties;
...
public class Properties implements IProperties {
	...
	private final SimpleBooleanProperty customFXMLLoaded = new SimpleBooleanProperty();
	private final SimpleBooleanProperty customCSSLoaded = new SimpleBooleanProperty();
	private final SimpleBooleanProperty customSettingsLoaded = new SimpleBooleanProperty();
	private final SimpleBooleanProperty customSettingsSaved = new SimpleBooleanProperty();

	private final SimpleBooleanProperty fileSelected = new SimpleBooleanProperty();
